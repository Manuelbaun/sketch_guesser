...
export default class Graph extends React.Component {
    ...
    _onDragMove = (ev, index, nodeList) => {
        ...
        if (!this.state.config.staticGraph) {
            ...
            this.props.onNodeDragMove && this.props.onNodeDragMove(draggedNode)
    ...
    render() {  
        ...
        const stateNodes = this._dirtyFixForStateNotes();
        // console.log(this.state.nodes, stateNodes)
        ...
        // console.log("render", nodes[0].props.x, nodes[0].props.y)
        // Object.values(this.state.nodes).forEach(node => console.log(node.x,node.y))
        const svgStyle = {
