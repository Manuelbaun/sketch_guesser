...
// export const outdatedTimeout = 5000;
...
export class Awareness extends Observable {
	/**
   * @param {Y.Doc} doc
   * @param {number} outdatedTimeout in ms
   */
	constructor(doc, outdatedTimeout = 30000) {
		super();
		this.doc = doc;
		/**
     ...
     */
		...
		this._checkInterval = setInterval(() => {
			...
			if (
				...
				outdatedTimeout / 2 <= now - /** @type {{lastUpdated:number}} */ this.meta.get(doc.clientID).lastUpdated
			) {
				// renew local clock
